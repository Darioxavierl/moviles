...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint((-1), 1, 10000))), False)
        self.analog_random_source_x_0.set_block_alias("Bits")
        ...
        self.connect((self.blocks_packed_to_unpacked_xx_0, 0), (self.digital_gmsk_mod_0, 0))
