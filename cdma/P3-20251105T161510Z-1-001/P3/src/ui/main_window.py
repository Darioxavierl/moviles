...
class MainWindow(QMainWindow):
    ...
    def _create_parameters_group(self) -> QGroupBox:
        ...
        self.combo_code_type.addItems(["Walsh", "Gold"])
        self.combo_code_type.setToolTip("Tipo de códigos de esparcimiento ortogonales")
    ...
    def _create_results_tab(self) -> QWidget:
        ...
        self.table_results.setHorizontalHeaderLabels([
            "Usuario", "Mensaje Original", "Mensaje Decodificado", "BER", "Estado"
        ])
...
• SNR: {summary['parameters']['snr_db']} dB<br>
• Umbral de decisión: {summary['parameters']['decoder_rate']}<br>

<b>Resultados:</b><br>
• BER promedio: {summary['metrics']['average_ber']:.4f}<br>
• BER mínimo: {summary['metrics']['min_ber']:.4f}<br>
• BER máximo: {summary['metrics']['max_ber']:.4f}<br>
